...
@pytest.fixture
def run_executor(run_service: RunService, environment_service: EnvironmentService, mock_k8s_service):
    """Create a RunExecutor with real run/env services and mocked K8s."""
    return RunExecutor(
