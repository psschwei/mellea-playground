...
import { LoginPage, RegisterPage, DashboardPage, ProgramsPage, ProgramDetailPage, CredentialsPage, RunsPage, RunDetailPage, CatalogPage, AssetDetailPage, ModelsPage, BuilderPage, CompositionsPage, SharedWithMePage, AdminDashboardPage } from '@/pages';
